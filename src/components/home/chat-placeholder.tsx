  ...
  return (
    <div className="w-3/4 bg-gray-secondary flex flex-col items-center justify-center py-10">
      <div className="flex flex-col items-center w-full justify-center py-10 gap-4">
        ...
        />
        <p className="text-3xl font-semibold mt-5 mb-2">Welcome to CheForum</p>
        <p className="w-1/2 text-center text-gray-primary text-sm text-muted-foreground">
          Make video calls, share your screen, and connect with people around the world.
        </p>

        <a
          href="mailto:kurisanim2@gmail.com"
          className="rounded-full my-5 bg-blue-600 hover:bg-blue-800 text-white px-4 py-2"
        >
          Get in Touch
        </a>
      </div>
